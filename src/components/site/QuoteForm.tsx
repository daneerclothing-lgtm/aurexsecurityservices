    ...
    return (
      <div className="glass rounded-md p-10 text-center">
        ...
        <p className="mt-2 text-muted-foreground text-sm">
          A senior account manager will be in touch within one business hour, 24/7.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={onSubmit} className="glass rounded-md p-6 md:p-10 grid gap-5 md:grid-cols-2">
      ...
      <div className="md:col-span-2 flex flex-col sm:flex-row items-center gap-4 pt-2">
        <button
          type="submit"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-sm font-medium text-primary-foreground bg-[image:var(--gradient-gold)] hover:brightness-110 transition-all shadow-gold-glow"
        >
          Get Free Security Assessment
        </button>
        <p className="text-xs text-muted-foreground">
          No obligation. Response within 1 business hour.
        </p>
      </div>
    </form>
  );
