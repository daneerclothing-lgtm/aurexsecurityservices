...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aurex Security Services | Leading UK Security & Protection" },
      { name: "description", content: "Aurex Security Services is a UK-based security company. Our officers hold SIA badges and provide professional manned guarding, CCTV monitoring, and corporate pr" },
      { name: "author", content: "Aurex Security Services" },
      { name: "theme-color", content: "#0c0f1a" },
      { property: "og:title", content: "Aurex Security Services | Leading UK Security & Protection" },
      { property: "og:description", content: "Aurex Security Services is a UK-based security company. Our officers hold SIA badges and provide professional manned guarding, CCTV monitoring, and corporate pr" },
