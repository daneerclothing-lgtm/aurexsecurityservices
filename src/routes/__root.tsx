      ...
      <body>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(d,t){var v=d.createElement(t),s=d.getElementsByTagName(t)[0];v.onload=function(){window.voiceflow.chat.load({verify:{projectID:'6a39799e9e16686a834da714'},url:'https://general-runtime.voiceflow.com',voice:{url:'https://runtime-api.voiceflow.com'},theme:{position:'left',sideSpacing:20,bottomSpacing:95}});var i=setInterval(function(){var c=d.getElementById('voiceflow-chat')||d.querySelector('voiceflow-chat');if(c){c.style.left='1.5rem';c.style.right='auto';clearInterval(i)}},500);setTimeout(function(){clearInterval(i)},15000)};v.src='https://cdn.voiceflow.com/widget-next/bundle.mjs';v.type='text/javascript';s.parentNode.insertBefore(v,s)})(document,'script');`,
          }}
        />
      </body>
    </html>
