...
export const Route = createFileRoute("/cookies")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How aurexsecurity.co.uk uses cookies under UK and EU regulations." },
      { property: "og:title", content: "Cookie Policy — Aurex Security" },
      { property: "og:description", content: "How aurexsecurity.co.uk uses cookies under UK and EU regulations." },
...
function Page() {
  return (
    <Section eyebrow="Legal" title="Cookie Policy" description="How aurexsecurity.co.uk uses cookies under UK and EU regulations.">
