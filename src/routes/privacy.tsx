...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "How Aurex Security collects, uses and protects personal data under UK GDPR.",
      },
...
function Page() {
  return (
    <Section
      ...
      description="How Aurex Security collects, uses and protects personal data under UK GDPR."
    >
