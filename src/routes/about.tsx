...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aurex Security Services is a UK SIA-licensed security company. Learn about our mission, vetting standards and operational excellence." },
      { property: "og:title", content: "About Aurex Security" },
      { property: "og:description", content: "Mission, vetting and operational standards behind Aurex Security." },
    ...
    <>
      <section className="relative pt-28 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto container-px">
          <div className="inline-flex items-center gap-3 mb-5">
            <span className="h-px w-8 bg-gold" /><span className="text-[11px] uppercase tracking-[0.28em] text-gold">About Aurex</span>
          </div>
          <h1 className="font-display text-5xl md:text-7xl leading-[1.02] max-w-4xl">A modern UK security company built on <span className="gradient-gold-text">discipline, discretion and trust.</span></h1>
        </div>
      </section>

      <Section eyebrow="Our Mission" title={<>Professional, trusted, <span className="gradient-gold-text">client-focused</span> UK security solutions.</>}>
        <div className="grid gap-10 lg:grid-cols-2 items-start">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { i: Target, t: "Mission-Led", d: "A single operating standard across every contract." },
              ...
              { i: ShieldCheck, t: "Compliant", d: "SIA, ACS-aligned and GDPR compliant by design." },
            ].map((b) => (
      ...
      <section className="py-16 bg-charcoal/70 border-y border-border/40">
        <div className="max-w-7xl mx-auto container-px grid gap-8 sm:grid-cols-4 text-center">
          {[
            ...
            <div key={x.l}>
              <div className="font-display text-5xl gradient-gold-text"><Counter to={x.v} suffix={x.s} /></div>
              <div className="text-xs uppercase tracking-[0.22em] text-muted-foreground mt-3">{x.l}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <Section>
        <div className="text-center max-w-2xl mx-auto">
          ...
          <Link to="/contact" className="mt-7 inline-flex items-center gap-2 px-7 py-4 rounded-sm font-medium text-primary-foreground bg-[image:var(--gradient-gold)] hover:brightness-110 transition-all shadow-gold-glow">
