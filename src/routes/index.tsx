  ...
  head: () => ({
    meta: [
      { title: "Aurex Security Services | SIA Licensed UK Security Company" },
      {
        name: "description",
        content:
          "Trusted UK security services. SIA licensed officers, CCTV monitoring, event & corporate protection across London and the UK. Get a free quote.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "SIA licensed manned guarding, CCTV, events and corporate protection across the UK.",
      },
  ...
  return (
    <>
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        <img
          src={heroImg}
          alt="UK security officer in a luxury corporate lobby"
        ...
        <div className="relative max-w-7xl mx-auto container-px py-24 md:py-32 grid lg:grid-cols-12 gap-12 w-full">
          <div className="lg:col-span-7 animate-fade-up">
            ...
            <p className="mt-7 max-w-xl text-base md:text-lg text-foreground/75 leading-relaxed">
              SIA licensed security guards, manned CCTV monitoring, event security and corporate
              protection — delivered to a standard you can rely on, 24 hours a day.
            </p>
            <div className="mt-9 flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                className="group inline-flex items-center justify-center gap-2 px-7 py-4 rounded-sm font-medium text-primary-foreground bg-[image:var(--gradient-gold)] hover:brightness-110 transition-all shadow-gold-glow"
              >
                Get Free Quote{" "}
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-sm font-medium border border-gold/40 text-foreground hover:bg-gold/10 hover:border-gold transition-all"
              >
          ...
          <div className="hidden lg:block lg:col-span-5 relative">
            ...
            <div
              className="relative glass rounded-md p-7 shadow-luxe animate-fade-up"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={s.k}
                    className="rounded-sm border border-border/60 bg-background/40 p-4"
                  >
              ...
              <div className="mt-5 flex items-center gap-3">
                <div className="flex -space-x-2">
                  {["JM", "AR", "SK"].map((i) => (
                    <div
                      key={i}
                      className="h-9 w-9 rounded-full border border-gold/30 bg-charcoal text-xs flex items-center justify-center text-gold font-medium"
                    >
                      {i}
                    </div>
                  ))}
      ...
      <section className="border-y border-border/40 bg-charcoal/60">
        <div className="max-w-7xl mx-auto container-px py-6 flex flex-wrap items-center justify-center gap-x-12 gap-y-3 text-xs uppercase tracking-[0.22em] text-muted-foreground">
          ...
          {[
            ...
            <span key={c} className="font-display text-base text-foreground/70">
              {c}
            </span>
          ))}
        </div>
      ...
      <Section
        ...
        title={
          <>
            ...
            <em className="not-italic gradient-gold-text">worth trusting.</em>
          </>
        }
        description="Aurex Security Services is a UK-based, SIA-regulated security company delivering professional manned guarding, CCTV monitoring and corporate protection. Built on three years of operational excellence and a no-compromise approach to vetting and training."
      >
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          <div className="space-y-6">
            <p className="text-muted-foreground leading-relaxed">
              Every officer we deploy is SIA licensed and trained against an internal operating
              standard refined across hundreds of UK contracts. From reception desks to high-risk
              construction sites, our officers represent your brand with discipline and discretion.
            </p>
            ...
            >
              Learn more about Aurex <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={s.k} className="glass rounded-md p-6">
                <div className="font-display text-4xl gradient-gold-text">
      ...
      <Section
        ...
        title={
          <>
            The qualities <span className="gradient-gold-text">enterprise UK clients</span> insist
            on.
          </>
        }
      >
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {WHY_CHOOSE.map((w) => (
            <div
              key={w.title}
              className="group p-7 rounded-md border border-border/60 bg-surface/50 hover:border-gold/50 transition-all hover:-translate-y-1"
            >
      ...
      <section className="py-20 bg-charcoal/70 border-y border-border/40">
        <div className="max-w-7xl mx-auto container-px grid gap-10 sm:grid-cols-3 text-center">
          {[
            ...
            <div key={s.label}>
              <div className="font-display text-5xl md:text-6xl gradient-gold-text">
                <Counter to={s.v} suffix={s.suffix} />
              </div>
              <div className="mt-3 text-xs uppercase tracking-[0.28em] text-muted-foreground">
                {s.label}
              </div>
            </div>
          ))}
      ...
      <Section
        ...
        title={
          <>
            Reviewed by clients who <span className="gradient-gold-text">trust us nightly.</span>
          </>
        }
      >
          ...
          {TESTIMONIALS.map((t) => (
            <figure key={t.name} className="glass rounded-md p-8 relative">
              ...
              <figcaption className="mt-6 flex items-center gap-4">
                <div className="h-11 w-11 rounded-full border border-gold/30 bg-charcoal text-gold font-medium flex items-center justify-center">
                  {t.avatar}
                </div>
                <div>
      ...
      <Section
        ...
        title={
          <>
            Real outcomes, <span className="gradient-gold-text">measured precisely.</span>
          </>
        }
      >
        <div className="grid gap-5 md:grid-cols-2">
          {CASE_STUDIES.map((c, idx) => (
            ...
            >
              ...
              <div className="mt-5 space-y-3 text-sm">
                <p>
                  <span className="text-gold font-medium">Challenge — </span>
                ...
                <p>
                  <span className="text-gold font-medium">Result — </span>
      ...
      <Section
        ...
        title={
          <>
            Request a <span className="gradient-gold-text">free security assessment.</span>
          </>
        }
        description="A senior account manager will contact you within one business hour, day or night."
      >
        <div className="grid gap-10 lg:grid-cols-5">
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li className="flex gap-3">
                  <span className="font-display text-gold">01.</span> Detailed risk and site
                  discovery call.
                </li>
                <li className="flex gap-3">
                  <span className="font-display text-gold">02.</span> Bespoke deployment plan and
                  SLA proposal.
                </li>
                <li className="flex gap-3">
                  <span className="font-display text-gold">03.</span> Officer mobilisation in as
                  little as 24 hours.
                </li>
              </ul>
            </div>
            <div className="glass rounded-md p-6">
              ...
              <a href="tel:+447723406782" className="font-display text-3xl gradient-gold-text">
                +44 7723 406782
              </a>
              <p className="text-xs text-muted-foreground mt-3">
                24/7 Operations · hello@aurexsecurity.co.uk
              </p>
            </div>
            <img
              src={eventImg}
              alt="UK event security officer"
        ...
        <div className="relative max-w-7xl mx-auto container-px flex flex-col lg:flex-row items-center justify-between gap-8">
          <div>
            ...
            <h2 className="font-display text-3xl md:text-5xl">
              Need <span className="gradient-gold-text">emergency security</span> coverage?
            </h2>
            <p className="mt-3 text-muted-foreground max-w-xl">
              Rapid deployment of SIA-licensed officers across the UK. Speak to a senior controller
              now.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-sm font-semibold bg-[image:var(--gradient-gold)] text-primary-foreground shadow-gold-glow hover:brightness-110 transition-all"
            >
              <Phone className="h-4 w-4" /> Call +44 7723 406782
            </a>
            <Link
              to="/emergency"
              className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-sm font-medium border border-gold/40 hover:bg-gold/10 transition-colors"
            >
              Emergency Details
            </Link>
          </div>
