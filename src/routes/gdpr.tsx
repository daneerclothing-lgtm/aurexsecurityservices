...
export const Route = createFileRoute("/gdpr")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aurex Security's commitments under the UK GDPR and Data Protection Act 2018." },
      { property: "og:title", content: "GDPR Compliance — Aurex Security" },
      { property: "og:description", content: "Aurex Security's commitments under the UK GDPR and Data Protection Act 2018." },
...
function Page() {
  return (
    <Section eyebrow="Legal" title="GDPR Compliance" description="Aurex Security's commitments under the UK GDPR and Data Protection Act 2018.">
